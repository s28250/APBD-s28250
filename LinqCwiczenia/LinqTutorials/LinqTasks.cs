...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            return Emps.GroupBy(emp => emp.Deptno)
                ...
                .Select(group => new { Name = Depts.FirstOrDefault(d => d.Deptno == group.Key)?.Dname.ToUpper(), numOfEmployees = group.Count() });
        }
        ...
        {
            var employeeGroups = Emps.GroupBy(emp => emp.Deptno)
                                                    .ToDictionary(g => g.Key, g => g.Count());
            return Depts.Where(dept => employeeGroups.TryGetValue(dept.Deptno, out int count) && (count == 5 || count == 0))
        ...
        {
            return Emps.Join(Depts, emp => true, dept => true, (emp, dept) => new { Emp = emp, Dept = dept });
        }
    }
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Where(e => emps.Any(e2 => e2.Mgr == e))
                .OrderBy(e => e.Ename)
